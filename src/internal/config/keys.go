...
var orderedSpecs = []KeySpec{
	{Key: "CHANNEL_TYPE", Scope: ScopeUserEnv, Default: defaultChannelType},
	{Key: "ACP_AGENT_CMD", Scope: ScopeUserEnv, Default: defaultACPAgentCmd},
	{Key: "ACP_PERMISSION_POLICY", Scope: ScopeUserEnv, Default: defaultPermissionPolicy},
	{Key: "SMS_FETCH_CMD", Scope: ScopeUserEnv, Default: defaultFetchCmd},
	{Key: "SMS_SEND_CMD", Scope: ScopeUserEnv, Default: defaultSendCmd},
	{Key: "REMOTE_USER_ID", Scope: ScopeUserEnv, Default: "tester"},
	{Key: "ALLOWED_FROM", Scope: ScopeUserEnv, Default: "tester"},
	{Key: "IMESSAGE_FETCH_CMD", Scope: ScopeUserEnv, Default: defaultIMessageFetchCmd},
	{Key: "IMESSAGE_SEND_CMD", Scope: ScopeUserEnv, Default: defaultIMessageSendCmd},
	...
	{Key: "CAG_GO_DEBUG", Scope: ScopeUserEnv, Default: "1"},
	{Key: "STORAGE_BACKEND", Scope: ScopeUserEnv, Default: defaultStorageBackend},
